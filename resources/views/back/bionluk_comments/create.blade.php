        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Bionluk Yorum Ekle</h6>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    @endif
                <form method="POST" action="{{route('bionluk_comment.store')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label>Yorum</label>
                            <textarea type="text" rows="15" class="form-control" name="comment"></textarea>
                        </div>
